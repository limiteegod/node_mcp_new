        ...
        function (callback) {
            table.findAndRemove({}, {}, [], function(err, ticket){
                ...
                if(ticket)
                {
                    ...
                    var trueBonus = bonusDetail.bonus*ticket.multiple;
                    var trueBonusBeforeTax = bonusDetail.bonusBeforeTax*ticket.multiple;
                    async.waterfall([
                        //找到对应的订单
                        function(cb)
                        {
                        ...
                        function(order, cb)
                        {
                            var object = {_id:ticket._id, bonus:trueBonus, bonusBeforeTax:trueBonusBeforeTax,
                        ...
                        function(order, cb)
                        {
                            ...
                            var data = {
                                ...
                                $inc:
                                {
                                    ticketCount:1,
                                    bonus:trueBonus,
                                    bonusBeforeTax:trueBonusBeforeTax
                                }
                            };
                        ...
                        function(order, cb)
                        {
                            ...
                            {
                                var schemeCode = schemeType.getInfoById(order.schemeType).code;
                                //已经算奖方案的缓存队列
                                var schemeColName = 'check_scheme_' + schemeCode + "_" + term.gameCode + "_" + term.code;
