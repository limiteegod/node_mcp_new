 ...
 */
var dbs = {devLocal:{ config:{host:'localhost',user:'root',password:'123456',port:3306,database:'mcp'},
                      type:esdb.prop.dbType.mysql,
                      dateToLong:false},
           oraLocal:{ config:{hostname: "192.168.11.118",port: 1521,database:"lottery",user: "liming",password: "0okmnhy6"},
                      type:esdb.prop.dbType.oracle},
           devMg:{    config:{'url':'mongodb://127.0.0.1:27017/mcp'},
                      type:esdb.prop.dbType.mongodb},
           devCache:{ config:{'url':'mongodb://127.0.0.1:27017/mcp_cache'},
                      type:esdb.prop.dbType.mongodb},
           runOra:{   config:{hostname: "192.168.222.231",port: 1521,database:"mcp",user: "mcpapp",password: "cde321QAZX"},
                      type:esdb.prop.dbType.oracle},
           runMg:{    config:{'url':'mongodb://192.168.222.233:27017/mcp'},
                      type:esdb.prop.dbType.mongodb},
           runCache:{ config:{'url':'mongodb://192.168.222.234:27017/mcp_cache'},
                      type:esdb.prop.dbType.mongodb},
           yunMysql:{ config:{'host':'10.131.172.66','user':'root','password':'0okmnhy6','port':3306,'database':'mcp'},
                      type:esdb.prop.dbType.mysql,
                      dateToLong:false},
           yunMg:{    config:{'url':'mongodb://10.131.172.66:27017/mcp'},
                      type:esdb.prop.dbType.mongodb},
           yunCache:{ config:{'url':'mongodb://10.131.172.66:27017/mcp_cache'},
                      type:esdb.prop.dbType.mongodb}
};
exports.dbs = dbs;
