var Game = function(){
    var self = this;
    self.info = [
        {id:'F01', name:'双色球', type:1, playTypes:
            [
        ...
        {id:'F02', name:'福彩3d', type:1, playTypes:
            [
        ...
        {id:'F03', name:'七乐彩', type:1, playTypes:
            [
        ...
        {id:'F04', name:'快3', type:2, playTypes:
            [
        ...
        {id:'T01', name: '大乐透', type:1, playTypes:
            [
                {id:'00', name:'标准', price:200, betTypes:
                    [
                        {id:'00', name: '单式'},
        ...
        {id:'T02', name: '七星彩', type:1, playTypes:
            [
                {id:'00', name:'一般投注', price:200, betTypes:
                    [
                        {id:'00', name: '单式'},
                        {id:'01', name: '复式'}
                    ]
        ...
        {id:'T03', name: '排列三', type:1, playTypes:
            [
                {id:'01', name:'直选', price:200, betTypes:
                    [
                        {id:'00', name: '单式'},
                ...
                {id:'02', name:'组选三', price:200, betTypes:
                    [
                        {id:'01', name: '复式'},
                        {id:'02', name: '胆拖'},
                        {id:'06', name: '跨度'}
                ...
                {id:'03', name:'组选六', price:200, betTypes:
                    [
                        {id:'01', name: '复式'},
                        {id:'02', name: '胆拖'},
                        {id:'06', name: '跨度'}
        ...
        {id:'T04', name: '排列五', type:1, playTypes:
            [
                {id:'00', name:'一般投注', price:200, betTypes:
                    [
                        {id:'00', name: '单式'},
        ...
        {id:'T05', name:'11选5', type:2, playTypes:
            [
        ...
        {id:'T06', name:'新快赢481', type:2, playTypes:
            [
        ...
        {id:'T51', name:'竞彩足球', type:3, playTypes:
            [
                ...
                {id:'11', name:'单场-胜平负', price:200, betTypes:[
                    {id:'00', name:'默认'}
                ]},
                {id:'12', name:'单场-让球胜平负', price:200, betTypes:[
                    {id:'00', name:'默认'}
                ]},
                {id:'13', name:'单场-比分', price:200, betTypes:[
                    {id:'00', name:'默认'}
                ]},
                {id:'14', name:'单场-总进球', price:200, betTypes:[
                    {id:'00', name:'默认'}
                ]},
                {id:'15', name:'单场-胜负半全场', price:200, betTypes:[
                    {id:'00', name:'默认'}
                ]}
            ]
        },
        {id:'T53', name:'胜负彩', type:1, playTypes:
            [
                {id:'01', name:'十四场', price:200, betTypes:[
                    {id:'00', name:'单式'},
                    {id:'01', name:'复式'}
                ]},
                {id:'02', name:'任九场', price:200, betTypes:[
                    {id:'00', name:'单式'},
                    {id:'01', name:'复式'}
                ]}
            ]
        },
        {id:'T54', name:'进球彩', type:1, playTypes:
            [
                {id:'01', name:'四场进球', price:200, betTypes:[
                    {id:'00', name:'单式'},
                    {id:'01', name:'复式'}
                ]}
            ]
