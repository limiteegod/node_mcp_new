...
var stationType = cons.stationType;
var stationStatus = cons.stationStatus;
var stationGameStatus = cons.stationGameStatus;
...
StationPageControl.prototype.detail = function(headNode, bodyNode, cb)
{
    ...
    async.waterfall([
        ...
        function(code, cb)
        {
            var stTable = dc.mg.get("stInfo");
            stTable.findOne({_id:code}, {}, {}, function(err, data){
                if(data)
                {
                    backBodyNode.stInfo = data;
                    cb(null);
                }
                else
                {
                    var stInfo = {_id:code};
                    stTable.save(stInfo, {}, function(err, data){
                        backBodyNode.stInfo = stInfo;
                        cb(err);
                    })
                }
            });
