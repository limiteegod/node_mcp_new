...
var AdminControl = function(){
    ...
    'AD14':14, 'AD15':15, 'AD16':16, 'AD17':17, 'AD18':18, 'AD19':19, 'AD20':20,
    'AD21':21};
    self.cmdArray = [{},
        ...
        {id:20, code:'AD20', fromType:prop.digestFromType.CACHE, des:'期次开奖'},
        {id:21, code:'AD21', fromType:prop.digestFromType.CACHE, des:'删除渠道所有通知'}
    ];
};
...
AdminControl.prototype.checkAD21 = function(user, headNode, bodyNode, cb)
{
    cb(null);
};
...
AdminControl.prototype.handleAD20 = function(user, headNode, bodyNode, cb)
{
    var backBodyNode = {};
    var id = bodyNode.id;
    termSer.draw({id:id}, function(err, data){
        cb(err, backBodyNode);
    });
};
 ...
 * @param cb
 */
AdminControl.prototype.handleAD21 = function(user, headNode, bodyNode, cb)
{
    var backBodyNode = {};
    var colName = 'notify_queen_' + bodyNode.id;
    var table = dc.mg.getConn().collection(colName);
