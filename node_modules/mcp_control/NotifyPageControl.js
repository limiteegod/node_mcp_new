...
NotifyPageControl.prototype.detail = function(headNode, bodyNode, cb)
{
    var self = this;
    var backBodyNode = {title:"通知详情"};
    var colName = 'notify_queen_' + bodyNode.channelCode;
    var cond = {_id:parseInt(bodyNode.id)};
