...
DbCenter.prototype._initMg = function(cb)
{
    ...
    //add tables
    var cus_login = new Table(db, "cus_login", [
        new Column(db, "_id", "varchar", 80, false, undefined, true, false),
        new Column(db, "st", "varchar", 80, false, undefined),
        new Column(db, "lastActiveTime", "date", -1, false, undefined),
        new Column(db, "expiredTime", "date", 80, false, undefined)
    ]);
    db.put(cus_login);
    ...
    db.put(stInfoTable);
    var notifyChannel = new Table(db, "notify_channel_all", [
        new Column(db, "_id", "varchar", 80, false, undefined, true, false),
        new Column(db, "url", "varchar", 80, false, undefined),
        new Column(db, "key", "32", 80, false, undefined),
        new Column(db, "ftpPath", "varchar", 80, false, undefined),
        new Column(db, "status", "int", 80, false, undefined),
    ...
    db.put(notifyChannel);
    var term_seal_info = new Table(db, "term_seal_info", [
        new Column(db, "_id", "bigint", 80, false, undefined, true, false),
        new Column(db, "gameCode", "varchar", 80, false, undefined),
        new Column(db, "termCode", "varchar", 80, false, undefined),
        new Column(db, "sTime", "date", 80, false, undefined),
        new Column(db, "filePath", "varchar", 80, false, undefined)
    ]);
    db.put(term_seal_info);
    self.mg = db;
    self.mg.init(cb);
};
...
DbCenter.prototype._initCache = function(cb)
{
    ...
    //票据按天缓存表(已经结算)
    var ticket_cache = new Table(db, "ticket_cache", [
        new Column(db, "_id", "varchar", 32, false, undefined, true, false),
        new Column(db, "amount", "int", 11, false, undefined),
        ...
        new Column(db, "termCode", "varchar", 20, false, undefined),
...
DbCenter.prototype._initMain = function(cb)
{
    ...
    db.put(moneylog);
    var termlog = new Table(db, "termlog", [
        new Column(db, "id", "varchar", 32, false, undefined, true, false),
        new Column(db, "hTime", "date", -1, false, undefined),
        new Column(db, "handleCode", "int", 11, false, undefined),
        new Column(db, "userId", "varchar", 32, false, ''),
        new Column(db, "termId", "varchar", 32, false, undefined),
        new Column(db, "description", "varchar", 80, false, undefined)
    ]);
    db.put(termlog);
    var schemezh = new Table(db, "schemezh", [
        new Column(db, "id", "varchar", 32, false, undefined, true, false),
        new Column(db, "customerId", "varchar", 32, false, undefined),
        new Column(db, "channelCode", "varchar", 10, false, undefined),
        new Column(db, "gameCode", "varchar", 10, false, ''),
        new Column(db, "numList", "varchar", 400, false, undefined),
        new Column(db, "amount", "bigint", -1, false, undefined),
        new Column(db, "stationId", "varchar", 32, false, undefined),
        new Column(db, "amount", "bigint", -1, false, undefined),
        new Column(db, "createTime", "date", -1, false, undefined),
        new Column(db, "acceptTime", "date", -1, false, undefined),
        new Column(db, "orderCount", "int", 11, false, undefined),
        new Column(db, "finishedOrderCount", "int", 11, false, undefined),
        new Column(db, "cancelOrderCount", "int", 11, false, undefined),
        new Column(db, "status", "int", 11, false, undefined),
        new Column(db, "startTermCode", "varchar", 40, false, undefined),
        new Column(db, "curTermCode", "varchar", 40, false, undefined),
        new Column(db, "platform", "varchar", 40, false, undefined),
        new Column(db, "payType", "int", 11, false, undefined),
        new Column(db, "winStop", "int", 11, false, undefined),
        new Column(db, "bonus", "bigint", -1, false, undefined),
        new Column(db, "bonusBeforeTax", "bigint", -1, false, undefined),
        new Column(db, "printStationId", "varchar", 32, false, undefined)
    ]);
    ...
    var customer = new Table(db, "customer", [
        new Column(db, "id", "varchar", 32, false, undefined, true, false),
        new Column(db, "groupId", "varchar", 32, false, undefined),
        new Column(db, "name", "varchar", 40, false, undefined),
        new Column(db, "password", "varchar", 40, false, undefined),
        new Column(db, "nickyName", "varchar", 40, false, undefined),
        new Column(db, "phone", "varchar", 40, false, undefined),
        new Column(db, "email", "varchar", 80, false, undefined),
        new Column(db, "realName", "varchar", 40, false, undefined),
        new Column(db, "identityId", "varchar", 80, false, undefined),
        new Column(db, "regDate", "date", -1, false, undefined),
        new Column(db, "lastActiveTime", "date", -1, false, undefined),
        new Column(db, "lastLoginTime", "date", -1, false, undefined),
        new Column(db, "introducer", "varchar", 40, false, undefined),
        new Column(db, "recharge", "bigint", -1, false, undefined),
        new Column(db, "integral", "bigint", -1, false, undefined),
        new Column(db, "status", "int", 11, false, undefined),
        new Column(db, "channelCode", "varchar", 40, false, undefined),
        new Column(db, "version", "int", 11, false, undefined)
    ]);
    db.put(customer);
    var customeraccount = new Table(db, "customeraccount", [
        new Column(db, "id", "varchar", 32, false, undefined, true, false),
        new Column(db, "customerId", "varchar", 32, false, undefined),
        new Column(db, "stationId", "varchar", 32, false, undefined),
        new Column(db, "recharge", "bigint", -1, false, undefined),
        new Column(db, "prize", "bigint", -1, false, undefined),
        new Column(db, "integral", "int", 11, false, undefined),
        new Column(db, "status", "int", 11, false, undefined)
    ]);
    db.put(customeraccount);
    self.main = db;
    self.main.init(cb);
};
